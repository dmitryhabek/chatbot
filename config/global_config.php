...
/***************************************
  ...
  ***************************************/
  ...
  #define('_SESSION_PATH_', _ADMIN_PATH_ . 'C:\xampp\htdocs\test\admin\ses_a589fcc32b2e583faac8e2e9b4c2c4ef' . $path_separator);
  ...
  //------------------------------------------------------------------------
  $time_zone_locale = 'Asia/Kolkata'; // a full list can be found at http://uk.php.net/manual/en/timezones.php
  $dbh    = 'Localhost';  # dev remote server location
  $dbPort = '3306';    # dev database name/prefix
  $dbn    = 'amit';    # dev database name/prefix
  $dbu    = 'root';       # dev database username
  $dbp    = 'nitrite0123';  # dev database password
  ...
  $remember_up_to = 10;
  $debugemail = 'amitsaroj2012@gmail.com';
